  ...
  return (
    <header className="py-8 md:py-12 text-center relative">
        ...
        <div className="container mx-auto px-4">
            ...
            <p className="mt-3 text-4xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-blue-400 via-green-400 to-yellow-400 bg-clip-text text-transparent animate-gradient">Welcome to All-Subject English Enlightenment</p>
