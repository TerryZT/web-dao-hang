  ...
  return (
    <header className="py-8 md:py-12 text-center relative">
        ...
        <div className="container mx-auto px-4">
            ...
            <h1 style={{fontFamily: "'Dancing Script', cursive"}} className="text-5xl md:text-7xl font-bold tracking-tight bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent animate-gradient">HELLO</h1>
