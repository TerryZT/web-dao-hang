  ...
  return (
    <header className="py-12 md:py-16 text-center relative">
        ...
        <div className="container mx-auto px-4">
            ...
            <h1 className="text-5xl md:text-6xl font-bold font-headline tracking-tight">Hello</h1>
            <p className="mt-4 text-2xl md:text-3xl font-bold tracking-tight text-indigo-500">Welcome to All-Subject English Enlightenment</p>
